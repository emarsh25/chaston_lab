...
### Welcome to the Parkinson Flies Tutorial

In this tutorial you will see how all figures were created for the Parkinson Fly Comparison Paper. Feel free to experiment with the tutorial by changing the taxon levels or other similar changes.
...
wilcox <- wilcox.test(shannon_table$shannon_entropy~shannon_table$genotype)
...
wilcox <- wilcox.test(ace_table$ace~ace_table$genotype)
...
*commented out because it does not create a figure*
...
urlfile = "https://raw.githubusercontent.com/emarsh25/chaston_lab/master/Files/CURA_project/No_Wol/iPLA_noControl/"
...
fig1_Sb_permanova <- adonis2(flies_bc_dm ~ lab * genotype * vial_model, flies_unifrac_table, permutations = 1000)
...
flies.labs <- c("Bloomington", "Bellen")
names(flies.labs) <- c("Bloomington", "Bellen")
...
# breaks = c("Bloomington", "Bellen")
# labs = c("Bloomington", "Bellen")
# 
# make_ancom2_plots(urlpath = urlfile, file_path, map_path=map_path, mapper_file=url(mapper_url), taxonomic_level=taxonomic_level,var1=var1,var2=var2,var3=var3,newcol="newcol", the_id = "X.SampleID", main.var=main.var, adj.formula=adj.formula, random.formula = random.formula, repeat.var = repeat.var, multcorr=multcorr, sig=sig, prev.cut=prev.cut, Group = Group, color = ancom_colors, breaks = breaks, labs = labs)
```
...
urlfile = "https://raw.githubusercontent.com/emarsh25/chaston_lab/master/Files/CURA_project/No_Wol/iPLA/"
...
urlfile = "https://raw.githubusercontent.com/emarsh25/chaston_lab/master/Files/CURA_project/No_Wol/All/"
...
urlfile = "https://raw.githubusercontent.com/emarsh25/chaston_lab/master/Files/CURA_project/DJ_w1118/"
...
urlfile = "https://raw.githubusercontent.com/emarsh25/chaston_lab/master/Files/CURA_project/pBac_w1118/"
...
taxonomy <- "https://raw.githubusercontent.com/emarsh25/chaston_lab/master/Files/CURA_project/krona_work/taxonomy.tsv"
taxonomyR <- "https://raw.githubusercontent.com/emarsh25/chaston_lab/master/Files/CURA_project/krona_work/taxonomy_forR.csv"
table <- "https://raw.githubusercontent.com/emarsh25/chaston_lab/master/Files/CURA_project/krona_work/table.from_biom.tsv"
