...
source("~/Park-Proj/Evan_stuff/parkFlies/Files/CURA_project/16sscripts/make_taxon_plots_condense_2var_0.0.2.R")
source("~/Park-Proj/Evan_stuff/parkFlies/Files/CURA_project/16sscripts/g_legend.R")
source("~/Park-Proj/Evan_stuff/parkFlies/Files/CURA_project/16sscripts/pcoa_2var_0.0.2.R")
# source("~/Evan_stuff/16sscripts/make_distance_plot_0.0.2.R")
# source("~/Evan_stuff/16sscripts/ANCOM_updated_code.R")
source("~/Park-Proj/Evan_stuff/parkFlies/Files/CURA_project/16sscripts/make_ancom_plots_0.0.2.R")
source("~/Park-Proj/Evan_stuff/parkFlies/Files/CURA_project/16sscripts/ancom_tests.R")
source("~/Park-Proj/Evan_stuff/parkFlies/Files/CURA_project/16sscripts/ancom_v2.0.R")


devtools::install_github("emarsh25/chaston_lab@master")
learnr::run_tutorial("parkFlies", "parkFlies")
```
...
#UCLA
```{r UCLA}
setwd('~/Park-Proj/Evan_stuff/parkFlies/Files/CURA_project/No_Wol/UCLA/')
file_path <- "UCLA"
...
table <- adonis2(flies_unweighted_dm ~ genotype * vial_model, data= flies_unifrac_table, permutations=1000, by= 'terms')
round(table, 2)
...
table <- adonis2(flies_bc_dm ~ genotype * vial_model, flies_unifrac_table, permutations=1000)
round(table, 2)
...
setwd('~/Park-Proj/Evan_stuff/parkFlies/Files/CURA_project/No_Wol/Stanford/')
file_path <- "Stanford"
mapper_file <- "call_mapper.tsv"
...
## lab or orchard environment
table <- adonis2(flies_unweighted_dm ~ genotype * vial_model, flies_unifrac_table, permutations=1000)
round(table, 2)
...
```{r Bellen}
setwd('~/Park-Proj/Evan_stuff/parkFlies/Files/CURA_project/No_Wol/Bellen/')
file_path <- "Bellen"
mapper_file <- "call_mapper.tsv"
...
## lab or orchard environment
table <- adonis2(flies_unweighted_dm ~ genotype_class * vial_model, flies_unifrac_table, permutations=1000)
round(table, 2)
...
table <- adonis2(flies_bc_dm ~ genotype_class * vial_model, flies_unifrac_table, permutations=1000)
round(table, 2)
adonis(flies_bc_dm ~ genotype * sex * vial_model, flies_unifrac_table, permutations=1000)
...
```{r bellen_mutant}
setwd('~/Park-Proj/Evan_stuff/parkFlies/Files/CURA_project/No_Wol/bellen_mutants/')
...
```{r Pallanck}
setwd('~/Park-Proj/Evan_stuff/parkFlies/Files/CURA_project/No_Wol/Pallanck/')
file_path <- "Pallanck"
mapper_file <- "call_mapper.tsv"
...
setwd('~/Park-Proj/Evan_stuff/parkFlies/Files/CURA_project/No_Wol/All/')
file_path <- "All"
mapper_file <- "call_mapper.tsv"
...
```{r iPLA_noControls}
setwd('~/Park-Proj/Evan_stuff/parkFlies/Files/CURA_project/No_Wol/iPLA_noControl/')
...
## lab or orchard environment
table <- adonis2(flies_unweighted_dm ~ lab * genotype * vial_model, flies_unifrac_table, permutations=1000)
round(table, 2)
adonis(flies_unweighted_dm ~ genotype * vial_model * sex, flies_unifrac_table, permutations=1000)
...
table <- adonis2(flies_weighted_dm ~ lab * genotype * vial_model, flies_unifrac_table, permutations=1000)
round(table, 2)
adonis(flies_weighted_dm ~ genotype * sex * vial_model, flies_unifrac_table, permutations=1000)
...
table <- adonis2(flies_bc_dm ~ lab * genotype * vial_model, flies_unifrac_table, permutations=1000)
round(table, 2)
adonis(flies_bc_dm ~ genotype * sex * vial_model, flies_unifrac_table, permutations=1000)
...
```{r iPLA (with control)}
setwd('~/Park-Proj/Evan_stuff/parkFlies/Files/CURA_project/No_Wol/iPLA/')
file_path <- "iPLA"
mapper_file <- "call_mapper.tsv"
...
setwd('~/Park-Proj/Evan_stuff/parkFlies/Files/CURA_project/DJ_w1118/')
...
setwd('~/Park-Proj/Evan_stuff/parkFlies/Files/CURA_project/pBac_w1118/')
